...
export function EchoIcon(props) {
  return (
    <SvgIcon {...props} viewBox="0 0 100 100">
      <defs>
        <radialGradient id="echoGradient" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
          <stop offset="0%" style={{ stopColor: '#5D7EFF', stopOpacity: 1 }} />
          <stop offset="100%" style={{ stopColor: '#A260FF', stopOpacity: 1 }} />
        </radialGradient>
      </defs>
      <circle cx="50" cy="50" r="50" fill="url(#echoGradient)" />
      <circle cx="50" cy="50" r="30" fill="none" stroke="#FFFFFF" strokeWidth="1.5" strokeOpacity="0.3" />
      <circle cx="50" cy="50" r="38" fill="none" stroke="#FFFFFF" strokeWidth="1.5" strokeOpacity="0.2" />
      <circle cx="50" cy="50" r="46" fill="none" stroke="#FFFFFF" strokeWidth="1.5" strokeOpacity="0.1" />
      <g fill="#FFFFFF">
        {/* Microphone Head */}
        <path d="M50,25 C54.418,25 58,28.582 58,33 L58,47 C58,51.418 54.418,55 50,55 C45.582,55 42,51.418 42,47 L42,33 C42,28.582 45.582,25 50,25 Z" />
        {/* Microphone Stand */}
        <path d="M62,47 C62,53.627 56.627,59 50,59 C43.373,59 38,53.627 38,47 L41,47 C41,51.971 45.029,56 50,56 C54.971,56 59,51.971 59,47 L62,47 Z" />
        {/* Stem and Base */}
        <rect x="48" y="58" width="4" height="10" rx="1" />
        <path d="M42,68 H58 C59.1,68 60,68.9 60,70 V70 C60,71.1 59.1,72 58,72 H42 C40.9,72 40,71.1 40,70 V70 C40,68.9 40.9,68 42,68 Z" />
      </g>
      <text
        x="50"
        y="88"
